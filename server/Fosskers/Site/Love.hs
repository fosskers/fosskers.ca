...
love = do
  ...
  where
    ...
    h = do
      ...
      link_ [rel_ "stylesheet", type_ "text/css", href_ "/assets/fontawesome.min.css"]
      link_ [rel_ "stylesheet", type_ "text/css", href_ "/assets/brands.min.css"]
      link_ [rel_ "stylesheet", type_ "text/css", href_ "/assets/solid.min.css"]
