...
|   年 | プロジェクト           | 役割       | 言語        | 概要                                         |
|------+----------------------+------------+-------------+----------------------------------------------|
| 2026 | [[https://github.com/fosskers/mongoose][mongoose]]             | 作者       | Common Lisp | [[https://mongoose.ws/][Mongoose]] ウェブサーバーへのバインディング          |
|      | [[https://github.com/fosskers/html][html]]                 | 作者       | Common Lisp | 簡単なHTML生成                                |
|------+----------------------+------------+-------------+----------------------------------------------|
| 2025 | [[https://github.com/fosskers/logfmt][logfmt]]               | 作者       | Common Lisp | logfmtのパーサー                              |
|      | [[https://github.com/fosskers/fluent][fluent]]               | 作者       | Common Lisp | [[https://projectfluent.org/][Project Fluent]] のCL実装                       |
|      | [[https://github.com/fosskers/plurals][plurals]]              | 作者       | Common Lisp | 言語の「複数形」規則                            |
