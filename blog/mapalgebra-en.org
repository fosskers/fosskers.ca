...
Reasonable performance for idiomatic use? Tons of GOTCHAs?

Is it easy to write complex spaghetti code? How's the learning curve? Is there
...
"below average" on these criteria.
For GIS in particular, its use should be avoided. I'll elaborate
on the points which are relevant to GIS (or Data Science) below.
...
image can't be larger than around 47,000 by 47,000 pixels, or GeoTrellis can't read it.
