...
All times are in milliseconds, shorter bars are better.
...
and NumPy has no support for them. ~mapalgebra~ and GeoTrellis both
host a greater variety.
...
libraries, use Rasterio. TODO talk about perf
