...
are lots of repeated imports, I added the following to a central ~Types.purs~ module:
...
~posts~ would be part of the greater HTML tree defined in ~render~. The important
