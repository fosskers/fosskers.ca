...
sudo pacman -S \
  ...
  xorg-xwayland xorg-xeyes qt5-wayland glfw-wayland
#+end_example
...
To get a list of all XWayland windows use ~xlsclients~ which outputs a list of
all windows using xwayland. Example output:
