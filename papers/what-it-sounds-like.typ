...
Demons threaten us and our world. They feast upon the living and feed our soul
...
this, she and her partners daylight as modern pop stars, and use their musical
influence to connect the hearts of their fans and power the Honmoon. They are
close to their goal, the culmination of generations of effort.
...
seeks to smooth back down. He wants the Hunters dead.

== The Hunters (The Conscious Ego)

While Rumi was born into the war she has dedicated her life to, we know nothing
about Mira's induction. Zoey was presumably scouted and trained during high
school, given that Huntrix has already won the Idol Awards five years in a row,
and Zoey states:
...
that the Saja Boys are Demons, to Rumi and Jinu the other is nothing more than
their surface identity. They haven't had a real conversation to break through
that wall of "other".

== The Bathhouse

This series of scenes serves to crack through that wall for the audience too,
...
of Rumi's demonic heritage, but to Jinu this is new information. After the fight
we see him legitimately curious about her as he strolls the alleyway. He's not
...
1. Disarm the enemy by mocking her appearance. // Aspects of 男女 here.
2. Blackmail her with knowledge she can't reveal to her social circle.
3. Confuse her by shaking her world view. // Demons can feel.
4. Tell her a doctored version of your tragic past to engender sympathy.
...
The Saja Boys are still moving to undermine everything Huntrix does, including a
...
3. Rumi wearing different clothing as Huntrix rehearses _Takedown_.
4. The train fight.
5. The _Free_ duet.
...
// not.
//
// How it's Done: English with Korean
// Golden: Japanese
// Soda Pop: English with Korean
// Takedown: English
// Feel: Japanese
...
// - Landing: right
// - Standing look at Saja screen: left
//
// Subway:
// - Landing: right
// - After the tear: left
// - Leap: right-handed "batter" swing. Right hand is higher.
//
// Confronting Seline:
...
// TODO: 2026-02-13 Style the URL!

For permanence, and because it's easier to share. Web pages change in
hard-to-track ways and can disappear entirely. This file and its contents are
